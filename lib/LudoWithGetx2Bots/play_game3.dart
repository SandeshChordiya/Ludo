...
import 'package:ludo2/LudoWithGetx3Bots/play_game2.dart';
import 'package:ludo2/LudoWithGetx3Bots/tile2.dart';
import 'package:ludo2/PlayGame.dart';
import 'package:ludo2/Tile.dart';

class PlayGame3 extends StatefulWidget {
  const PlayGame3({super.key});

  @override
  State<PlayGame3> createState() => _PlayGame3State();
}

class _PlayGame3State extends State<PlayGame3> {
  @override
